...
| 2026-09-09 | [013, Deterministic profile compiler and reversible installs](013-deterministic-profile-compiler.md) | active | Project every clone through one bounded compiler and track repository-local artifacts for removal |
